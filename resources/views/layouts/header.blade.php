    ...
    <ul class="flex items-center flex-shrink-0 space-x-6">
        ...
        <li class="relative">
            <button id="user-icon" class="align-middle focus:outline-none p-4">
                ...
                <ul id="user-panel" class="hidden absolute right-0 w-56 mr-4 p-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md z-10" aria-label="submenu">
                    <li class="flex">
